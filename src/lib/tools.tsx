...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description: "Format and pretty-print XML data.",
  },
  {
    slug: "yaml-formatter",
    name: "YAML Formatter",
  ...
  },
  {
    ...
    description: "Format and pretty-print HTML code.",
  },
  {
    slug: "sql-formatter",
    name: "SQL Formatter",
  ...
  // Database
  {
    ...
    description: "Write and execute SQL queries in an in-browser mock database.",
  },
];
